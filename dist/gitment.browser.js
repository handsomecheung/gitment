...
function renderFooter() {
  ...
  container.innerHTML = '\n    Powered by\n    <a class="gitment-footer-project-link" href="https://github.com/handsomecheung/gitment" target="_blank">\n      Gitment\n    </a>\n  ';
  return container;
}
  ...
  function Gitment() {
    ...
    if (query.code) {
      var _oauth = this.oauth,
          ...
          client_encoded_secret = _oauth.client_encoded_secret;
      ...
      _utils.http.post('https://gh-oauth.print4d.org/login/oauth/access_token', {
        code: code,
        client_id: client_id,
        client_encoded_secret: client_encoded_secret
      }, '').then(function (data) {
